...
from world_setup.utils import get_vehicle_locations, get_walker_locations, find_spawn_point, get_vehicle_and_walker_info
...
def game_loop(args, filename):
    ...
    try:
        ...
        data_exporter.results['weather']= "Default"
        data_exporter.results['number_of_vehicles']= 10
        data_exporter.results['number_of_walker']= 8
        data_exporter.results['ego_vehicle']= world.player.type_id
        data_exporter.results['start_positon']= "None"
        data_exporter.results['destination_position']= "None"
